...
const Modal: React.FC<ModalHuellaProps> = ({ abierto, estado, mensaje, onClose }) => {
    ...
    const Spinner = () => (
        <svg className="h-14 w-14 2xl:h-16 2xl:w-16 animate-spin text-blue-600 mx-auto" viewBox="0 0 24 24" fill="none">
    ...
    return (
        <div className="fixed inset-0  flex items-center justify-center bg-black/50 backdrop-blur-[1px] p-4 overscroll-contain">
            <motion.div  variants={modalVariant} initial="initial" animate="animate"  className="bg-white rounded-md shadow-2xl pt-10 pb-10 px-6 w-full max-w-[95%] sm:max-w-[32em] 2xl:max-w-160 2xl:pt-15 2xl:pb-15 text-center">
                <div className="mb-6">
                    <Spinner />
                </div>
                <h2 className="text-[1.5em] 2xl:text-3xl font-semibold text-[#545454] leading-tight mb-4">
                    Escaneando Huella
                </h2>
                <p className="text-[1rem] 2xl:text-xl text-[#545454] font-normal">
