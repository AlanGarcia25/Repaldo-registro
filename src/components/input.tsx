  ...
  ({ nombre = "", tipo = "text", placeholder = "", value, onChange, onBlur, readOnly = false, onKeyDown, max, min }, ref) => {
    return (
      <div className="flex flex-col align-center py-2">
        ...
        <input
          ref={ref}
          className={`${readOnly ? "cursor-not-allowed " : "focus:border-blue-700 bg-transparent"} truncate w-full min-w-0 border-b-[.1px] border-black p-1.5 focus:outline-none font-sans placeholder:italic`}
          type={tipo}
